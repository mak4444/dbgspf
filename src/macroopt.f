\ $Id: macroopt.f,v 1.77 2012/03/22 16:46:15 mihail4444 Exp $
\ 
...
:  -EBPCLR   ( FLAG OPX  -- FLAG' )
  ...
  BEGIN
     ...
     DUP @ W@ 6D8D = IF DROP EXIT THEN \ lea  ebp, X[rbp]
...
OP1 @ W@ FFFD AND 4589 XOR    \  MOV     F8 [EBP] , EAX
OP0 @ W@ FFFD AND 4589 XOR OR \  MOV     EAX , F8 [EBP]
OP1 @ 2+ C@
OP0 @ 2+ C@    XOR OR
0=  IF   M\ 1AC DTST
       OP0 OPexcise
